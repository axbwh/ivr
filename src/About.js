        ...
        return (
            <div className='ivr-about'>
                ...
                <div className='paragraph'>
                    ...
                    <p className='indent'><b>Indigenous Partnership </b>refers to works where Indigenous practitioners contribute and are extensively involved in various levels of production, for example as producer, writer or designer, even though non-Indigenous practitioners may perform key creative and technical roles. </p>
                    <p className='indent'><b>Indigenous Collaboration</b> refers to works where Indigenous practitioners do not normally fulfill substantial creative or technical roles but have participated and contributed to the way their stories are told. This latter category can include extensive consultation and/or input into the final work but can also include scenarios where Indigenous agencies contract non-Indigenous companies to create the work. </p>
